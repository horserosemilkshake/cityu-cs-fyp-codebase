...
export const { setUsernameGlobal, setMaticBalance, setWarehouseNeededInThisRound, setSpeed, setCurrentCoordinate, setLastCoordinate, setTrunkLength, setTrunkWidth, setTrunkHeight, setCryptoWalletAddress, setCryptoWalletPassword } = profileSlice.actions;
