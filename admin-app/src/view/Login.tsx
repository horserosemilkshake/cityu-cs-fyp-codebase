...
import { baseURL, setUname } from '../global';
...
const Login = () => {
    ...
    const handleForgot = () => {
        setSnackbarMessage("Please contact the system admin if you forgot the login credentials.");
    ...
    return (
        ...
        //         <h1>Dandelion LMS (Admin App) Login Screen</h1>
        ...
        //         </div>
        //         <div className="form-group">
        //             <button onClick={() => {alert("Please contact the system admin if you forgot the password")}}>Forget username / password?</button>
        //         </div>
        //     </div>
        // </div>
                ...
                <div className='bg-gray-200 px-8 rounded-xl shadow-2xl'>
                    ...
                    <h1 className='normal-case text-center hover:animate-pulse duration-300 ease-in-out'>
                        <span className="inline-block animate-[typing_3s_steps(20)_1] whitespace-nowrap overflow-hidden normal-case text-center">
                            Dandelion LMS (Admin App) Login Screen<span className="absolute right-0 h-full border-r border-solid border-gray-400 animate-none"></span>
                        </span>
                    </h1>
                    <div className='py-4'></div>
                    ...
                    <div className='flex flex-row mt-4'>
                        ...
                        <div className="form-group">
                            <button className="bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 border border-gray-400 duration-300 ease-in-out" onClick={handleForgot}>Forget credentials?</button>
                        </div>
                    </div>
                </div>
            </div>
